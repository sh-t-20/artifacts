...
public class FixedLearningOrder {
...
//	static long seed = System.currentTimeMillis();
	static long seed = 1649770651312L;
...
//			System.out.println("\n" + Arrays.deepToString(products_similarity));
			...
			// m_1 order
			int[] learning_order_array = {1, 15, 14, 5, 9, 7, 12, 10, 6, 11, 13, 3, 2, 8, 4};
			
			// m_2 order
//			int[] learning_order_array = {2, 3, 1, 12, 7, 15, 13, 8, 9, 5, 6, 11, 10, 14, 4};
			
			// b_1 order
//			int[] learning_order_array = {5, 1, 16, 10, 8, 12, 9, 15, 6, 3, 2, 13, 14, 4, 7, 11};
			
			// b_2 order
//			int[] learning_order_array = {10, 12, 11, 8, 6, 15, 16, 13, 4, 3, 14, 5, 9, 7, 2, 1};

			List<Integer> learning_order = new ArrayList<Integer>();
			for (Integer o : learning_order_array) {
				learning_order.add(o);
			}
//			System.out.println("Order:"+learning_order);

			for (int i_1 = 0; i_1 < samples_count; i_1++) {
